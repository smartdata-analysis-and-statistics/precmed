...
survivalExample$previous_cost <- as.numeric(survivalExample$previous_cost + attr(survivalExample$previous_cost, "scaled:center"))
...
t.table1 <- print(CreateTableOne(vars = myVars, factorVars = catVars, strata = "trt", data = survivalExample), showAllLevels = TRUE)
```
