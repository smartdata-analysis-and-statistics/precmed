...
library(tableone)
survivalExample$age <- as.numeric(survivalExample$age)
survivalExample$previous_cost <- as.numeric(survivalExample$previous_cost)
...
myVars <- c("age", "female", "previous_treatment", "previous_cost", "previous_number_symptoms", "previous_number_relapses")
## Vector of categorical variables that need transformation
catVars <- c("female", "previous_treatment", "previous_number_symptoms", "previous_number_relapses")
## Create a TableOne object
t.table1 <- print(CreateTableOne(vars = myVars, factorVars = catVars, strata = "trt", data = survivalExample))
```
