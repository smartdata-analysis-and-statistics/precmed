...
## Load data set (Example data with count outcome)

To show the functionalities of the `precmed` package for count outcomes we first need data. For our examples we use simulated data that is located in the `countExample` data set. The data set `countExample` was simulated based on real-world claims data in multiple sclerosis and has 4,000 observations and 9 variables. 
