...
-------------       ----------
age                 The age (years) at baseline, centered at 48 years (such that is has a mean value of 0). 
female              The gender (0 for male, 1 for female).
previous_treatment  The previous treatment, "drugA", "drugB", or "drugC"
previous_cost       The medical costs in the year prior to treatment initiation. The variable has been standardized using a mean value of 13,824 USD and a standard deviation of 20,172 USD.
previous_number_symptoms  Test
...
countExample$age <- as.numeric(countExample$age)
countExample$previous_cost <- as.numeric(countExample$previous_cost)
...
myVars <- c("age", "female", "previous_treatment", "previous_cost", "previous_number_symptoms", "previous_number_relapses", "years")
## Vector of categorical variables that need transformation
catVars <- c("female", "previous_treatment", "previous_number_symptoms", "previous_number_relapses")
t.table1 <- print(CreateTableOne(vars = myVars, factorVars = catVars, strata = "trt", data = countExample))
```
