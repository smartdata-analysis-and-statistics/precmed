...
countExample$previous_cost <- as.numeric(countExample$previous_cost + attr(countExample$previous_cost, "scaled:center"))
...
t.table1 <- print(CreateTableOne(vars = myVars, factorVars = catVars, strata = "trt", data = countExample), showAllLevels = TRUE)
```
