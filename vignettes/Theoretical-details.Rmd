...
![ABC calculation examples in relation with `higher.y` argument in `catecv()` and `catefit()`. Validation curves are represented with a blue line and the dashed line is the ATE.](ABCexample.png)
...
![Figure. ABC calculation examples in relation with `higher.y` argument in `catecv()` and `catefit()`. Validation curves are represented with a blue line and the dashed line is the ATE.](ABCexample_survival.png)
