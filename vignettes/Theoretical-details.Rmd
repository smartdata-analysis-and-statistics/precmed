...
```{r, fig.cap = "ABC calculation examples in relation with `higher.y` argument in `catecv()` and `catefit()`. Validation curves are represented with a blue line and the dashed line is the ATE."}
...
```{r, echo = FALSE}
knitr::include_graphics("ABCexample_survival.png", dpi = 144)
```
