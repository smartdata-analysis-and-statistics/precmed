...
Vignettes are available at: https://smartdata-analysis-and-statistics.github.io/precmed/

These include:  
1. [General introduction to precmed](https://smartdata-analysis-and-statistics.github.io/precmed/docs/articles/general-introduction.html)
2. [Examples with count outcome of the entire workflow](https://smartdata-analysis-and-statistics.github.io/precmed/docs/articles/count-examples.html)
3. [Examples with survival outcome of the entire workflow](https://smartdata-analysis-and-statistics.github.io/precmed/docs/articles/survival-examples.html)
4. [Additional examples for the `precmed` package](https://smartdata-analysis-and-statistics.github.io/precmed/docs/articles/additional-examples.html)
5. [Theoretical details](https://smartdata-analysis-and-statistics.github.io/precmed/docs/articles/theoretical-details.html)
